...
void ripser_func() {
    std::cout << "ripser included" << std::endl;
}
...
compressed_lower_distance_matrix
read_file(std::istream &input_stream, const file_format format, const std::set<int> &subcloud) {
    switch (format) {
        ...
        case POINT_CLOUD:
            return read_point_cloud(input_stream, subcloud);
        case DIPHA:
